...
{
    public class SchedulerListenerService : ISchedulerListenerService, IJobListener, ITriggerListener, ISchedulerListener
    {
        ...
        {
            OnJobExecutionVetoed?.Invoke(this, new EventArgs<IJobExecutionContext>(context, cancellationToken));
            return Task.CompletedTask;
        }
        ...
        {
            OnJobUnscheduled?.Invoke(this, new EventArgs<TriggerKey>(triggerKey, cancellationToken));
            return Task.CompletedTask;
        }
        ...
        {
            OnSchedulerError?.Invoke(this, new SchedulerErrorEventArgs
            {
                ErrorMessage = msg,
                Exception = cause,
        ...
        {
            OnTriggerComplete?.Invoke(this, new TriggerEventArgs(trigger, context, cancellationToken));
            return Task.CompletedTask;
        }
        ...
        {
            OnTriggerResumed?.Invoke(this, new EventArgs<TriggerKey>(triggerKey, cancellationToken));
            return Task.CompletedTask;
        }

        public Task TriggersPaused(string? triggerGroup, CancellationToken cancellationToken = default)
        {
            OnTriggerGroupPaused?.Invoke(this, new EventArgs<string?>(triggerGroup, cancellationToken));
            return Task.CompletedTask;
        }

        public Task TriggersResumed(string? triggerGroup, CancellationToken cancellationToken = default)
        {
            OnTriggerGroupResumed?.Invoke(this, new EventArgs<string?>(triggerGroup, cancellationToken));
            return Task.CompletedTask;
        }
